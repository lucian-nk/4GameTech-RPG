...
else
{
	...
	if($rows)
	{
		...
		$sql = "UPDATE players SET Password = '$passcont' WHERE Name = '$user'";
	    $resultnew = mysql_query($sql);
	    $message = "Hello, \n\n Username: $user \n\n Password: $passcont \n\n Visit our website: http://www.greentiger.ro";
		mail($email, 'Parola cont', $message, 'From: noreply@greentiger.ro');
